export const Bio = {
  ...
  export const experiences = [
    {
      id: 0,
      img: "https://en.wikipedia.org/wiki/Tungsten_Software#/media/File:Tungsten_Software_Logo.svg",
      role: "Data Scientist",
      company: "Tungsten Automation, formerly Kofax, USA",
      date: "Jan 2023 - Current",
      desc: "• Extracted and transformed data from over 20 diverse sources, improving data usability for analysis and processing in AWS and GCP environments by 30%.<br>• Delivered 15 high-quality datasets, meeting business analyst and customer reporting needs with a 95% accuracy rate.<br>• Established and maintained CI/CD pipelines, reducing deployment time by 35%.",
      skills: [
        "Data Extraction",
        "Data Transformation",
        "Data Analysis",
    ...
    {
      id: 1,
      img: "https://en.wikipedia.org/wiki/Sigma_Info_Solution#/media/File:Sigma_Info_Solution_Logo.svg",
      role: "Data Scientist",
      company: "Sigma Info Solution, India",
      date: "Aug 2019 - Jul 2021",
      desc: "• Developed and maintained robust data pipelines, streamlining the data ingestion process.<br>• Conducted exploratory data analysis to identify outliers and anomalies.",
      skills: [
        "Data Pipelines",
    ...
    },
    {
      ...
      desc: "• Conducted exploratory data analysis on large datasets, identifying key trends and patterns.<br>• Cleaned and pre-processed raw data, addressing missing values and outliers.",
      skills: [
        "Exploratory Data Analysis",
        "Data Cleaning",
        "Machine Learning",
  ...
  export const education = [
    {
      ...
      desc: "I am currently pursuing a Master's degree in Computer Science at California State University - Chico, CA, USA. I am expected to graduate in Dec 2023.",
    },
    {
      id: 1,
